(function (global) {
  ...
  var AI_SYSTEM_PROMPT = [
    'You are an AI assistant specialized in analyzing CRM conversation histories and attached PDF documents.',
    '',
    'Below are the case messages and optional PDF extracts you must use as context for all questions in this conversation.',
  ...
  var SUGGESTIONS = {
    ...
    documents: 'Answer based on the attached PDF document extracts. Mention which file(s) support your answer and say when information is missing.'
  };
